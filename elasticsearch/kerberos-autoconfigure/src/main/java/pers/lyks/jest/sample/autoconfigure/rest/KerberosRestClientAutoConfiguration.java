...
public class KerberosRestClientAutoConfiguration {
    ...
    public static class KerberosAuthenticateRestClientBuilderCustomizer implements RestClientBuilderCustomizer {
        ...
        public void customize(RestClientBuilder builder) {
            ...
            KerberosAuthenticHttpClientConfigCallbackHandler configCallbackHandler = new KerberosAuthenticHttpClientConfigCallbackHandler(hosts[0], kerberos.getUsername(), kerberos.getPassword(), kerberos.getLoginModule());
            try {
